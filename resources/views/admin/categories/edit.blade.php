                ...
                <div class="m-2 p-2 shadow bg-gray-200 rounded">
                  <form method="POST" enctype="multipart/form-data" action="{{route('admin.categories.update', $category->id)}}">
                    ...
                    <div class="mb-6 p-2">
                      ...
                      <div>
                        <img class="w-32 h-32" src="{{Storage::url($category->id)}}" alt="">
                      </div>
                    ...
                    <div class="mb-6">
                      ...
                      <input type="text" required id="description" name="description" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mt-6 p-4">
                      <button type="submit" value="{{$category->description}}" required class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Update</button>
                    </div>
                  </form>
